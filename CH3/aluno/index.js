...
let aluno1 = new aluno.ConstruirAluno('Robson Xavier',4,[3,5,1],this.calcularMedia,this.faltas)
let aluno2 = new aluno.ConstruirAluno('Thiago Funari', 4,[6,5,8], this.calcularMedia,this.faltas)
let aluno3 = new aluno.ConstruirAluno('Gustavo Brock', 2,[7,4,8], this.calcularMedia,this.faltas)
let aluno4 = new aluno.ConstruirAluno('Gabriel Franciso', 4,[2,3,8], this.calcularMedia,this.faltas)
let aluno5 = new aluno.ConstruirAluno('Guilherme Mello', 3,[8,4,8], this.calcularMedia,this.faltas)
